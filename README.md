...
# 💫 About Me:
🎓 I'm a Software Engineering student at SLIIT, passionate about turning real-world problems into innovative software solutions.  
🚀 I’ve developed web and IoT projects using Java, JSP, Servlets, Arduino, Spring Boot, and Android.  
🛠️ I'm currently building a Vehicle Rental System, a Movie Booking Web App, and a Smart Greenhouse using ESP modules.  
🎯 My dream is to become a Software Architect and one day make Nobel Prize–worthy contributions in AI, cybersecurity, or data science.  
🌍 I enjoy learning through real implementation and collaborating with like-minded developers.  
🎤 Fun Fact: I'm also on TikTok @CoderLifeVibes sharing developer humor, and I admire artists like Yohani and Kanchana Anuradhi.

---

### 🔭 I’m currently working on:
- CI/CD pipelines for real-world deployment  
- A tour customization system using Binary Search Trees  
- Event Photography Booking web platform (Java + JSP)

### 🤝 I’m open to collaborating on:
- Java/Spring backend projects  
- Full-stack student group work  
- IoT + Android integrations

### 🌱 I’m currently learning:
- Spring Boot, Thymeleaf, data structures in Java  
- Git collaboration & version control best practices  
- Clean coding, design patterns, and system architecture

### 💬 Ask me about:
- Java backend, OOP, GitHub tips, or API integration  
- Arduino + sensor programming  
- Project management and university coding assignments
...
# 📊 GitHub Stats:
![](https://github-readme-stats.vercel.app/api?username=Nadeesha-D-Shalom&theme=dark&hide_border=false&include_all_commits=false&count_private=false)<br/>
![](https://nirzak-streak-stats.vercel.app/?user=Nadeesha-D-Shalom&theme=dark&hide_border=false)<br/>
![](https://github-readme-stats.vercel.app/api/top-langs/?username=Nadeesha-D-Shalom&theme=dark&hide_border=false&include_all_commits=false&count_private=false&layout=compact)
